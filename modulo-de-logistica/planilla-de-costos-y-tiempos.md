...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/72B6lE7Nn0jKtcyB10gI/modulo-de-logistica/planilla-de-costos-y-tiempos
---
...
Dentro de estrategia de envío encontraremos las diferentes modalidades de envío configuradas en la plataforma. En este ejemplo tomaremos la llamada "Andreani a Sucursal" para mostrar el paso a paso.

Deberemos clickear sobre los tres botones y luego en editar.<br>

<figure><img src="../.gitbook/assets/2 (15).png" alt=""><figcaption></figcaption></figure>

Una vez dentro del método de envío deberemos ir a la sección Tarifas de envío y clickear en donde dice descargar tarifas en envío.<br>
