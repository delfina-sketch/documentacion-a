...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/72B6lE7Nn0jKtcyB10gI/modulo-de-catalogo/carga-de-productos-y-skus
---
...
**Producto** es como se le llama a un artículo que, por sus características, puede o no tener distintas variantes de sí mismo. Por ejemplo, **Set de Fundas de almohadas Queen Bambu Lisas.**&#x20;

**SKU** por el otro lado, es la variante específica de un producto, normalmente asociada al talle o al color. Retomando el ejemplo anterior, si **Set de Fundas de almohadas Queen Bambu Lisas** es un producto, su variante **Color Blanco** sería el SKU.
...
Por esto mismo, la **Set de Fundas de almohadas Queen Bambu Lisas** **Color Blanco** podría tener hasta 4 códigos de identificación distintos (sin contar el EAN/UPC), como por ejemplo sería:

* Product ID: 10681
* SKU ID: 18525
* Código de referencia de producto: 40902Q08340
* Código de referencia de SKU: 40902Q08340%H
...
Para realizar la carga manual de producto, nos debemos dirigir al administrador e ingresar a **Catálogo > Productos y SKUs**
...
Al ingresar, podremos ingresar a través de dos pestañas: Producto y SKUs. \
Ingresamos por Producto y tendremos algunos campos a completar:
...
* **SEO**: Estos campos influyen en el ranking del producto en motores de búsqueda como Google y Bing.
  ...
  *   **Metadescripción:** Muy breve descripción del producto, utilizado para SEO y para la información de los motores de búsqueda. La misma no debe excederse de 160 caracteres. <br>
...
{% hint style="danger" %}
Las tiendas VTEX IO utilizan el buscador inteligente de VTEX el cual utiliza la creación de [sinónimos ](sinonimos.md)para las búsquedas en lugar del campo **Palabras sustitutas.**&#x20;
{% endhint %}
...
* **Identificadores:**&#x20;
  ...
  *   **Código fiscal**: Número de identificación fiscal, normalmente no se utiliza.<br>

      <figure><img src="../.gitbook/assets/image (124).png" alt=""><figcaption></figcaption></figure>
*   **Especificaciones:** En caso de haber creado especificaciones de producto, se listarán en este apartado con sus opciones para seleccionar:<br>

    <figure><img src="../.gitbook/assets/image (112).png" alt=""><figcaption></figcaption></figure>

Ahora pasando a la pestaña de SKUs, encontraremos otros campos relevantes para la configuración de variantes. Desde el + podremos agregar la cantidad de SKUs que necesitemos:

<figure><img src="../.gitbook/assets/2 (1).png" alt=""><figcaption></figcaption></figure>

* **Nombre:** Será el nombre específico de esa variante. Ejemplo: Si el nombre de producto (autocompletado) es **Set de Fundas de Almohadas Queen Bambú Lisas**, el del SKU sería **Color Blanco**
* **Activo:** Nos dirá si la variante está o no activo.&#x20;
*   **Especificaciones:** Desde esta pestaña, vamos a visualizar las especificaciones creadas para este SKU desde la categoría y podremos asignarle los valores correspondientes. Para este ejemplo, tenemos creadas la especificación de Color. <br>
...
* **Contenido multimedia:** En este apartado podemos subir los archivos que serán relevantes para este SKU como:
  ...
  * **Videos:** Desde el **+Agregar,** nos abrirá un modal para completar la URL.

<figure><img src="../.gitbook/assets/4 (1).png" alt=""><figcaption></figcaption></figure>

<div align="right"><figure><img src="../.gitbook/assets/image (127).png" alt=""><figcaption></figcaption></figure></div>
...
* **Identificadores:**
  ...
  *   **Código del Fabricante:** proporcionado por el fabricante para identificar su producto. Si algún producto tiene un código específico, este campo debe rellenarse.<br>
...
* **Logística:**
  ...
  * **Medidas de stock:** Esta información se utiliza para especificar la unidad de medida que se empleará para contabilizar el ítem en el stock.
    ...
    *   **Multiplicador de Unidad:** unidad numérica que multiplica la cantidad seleccionada del producto cuando se agrega al carrito. En este caso, 1.<br>
...
* **Estrategia comercial:**&#x20;
  ...
  *   **Generar crédito en tarjeta de regalo?:** <br>
...
*   **Atributos:** Nos permite crear y asignar un atributo determinado y aplicar a todos los SKUs de ese producto. <br>

    <figure><img src="../.gitbook/assets/image (115).png" alt=""><figcaption></figcaption></figure>

{% hint style="info" %}
Al ser un tema amplio, **especificaciones se abordará en la siguiente documentación:** [**Especificaciones**](importacion-exportacion.md)
{% endhint %}

Una vez hayamos completado toda la información de nuestro SKU, le damos a "Guardar" y ¡listo! Ya con el SKU guardado, podremos repetir el proceso cuantas veces sea necesario para registrar cada una de las variantes posibles de ese producto.
