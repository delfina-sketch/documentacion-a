...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/72B6lE7Nn0jKtcyB10gI/modulo-de-catalogo/carga-de-imagenes
---
...
Una vez ahí, nos dirigimos a la pestaña **SKUs**, a la sección **Contenido Multimedia** y desde el ícono de Imágenes podremos cargar las imágenes que necesitemos. El texto no es obligatorio y etiqueta lo utilizaremos únicamente en casos particulares.<br>

<figure><img src="../.gitbook/assets/20.png" alt=""><figcaption></figcaption></figure>

También veremos varias imágenes: en principio, se puede distinguir la imagen principal de ese SKU porque tiene una estrellita que la identifica como la principal:<br>

<figure><img src="../.gitbook/assets/21.png" alt=""><figcaption></figcaption></figure>

En caso que queramos modificar la imagen principal, sólo debemos arrastrar la imagen que queramos a la primera posición y quedará destacada como la principal:

<figure><img src="../.gitbook/assets/22.gif" alt=""><figcaption></figcaption></figure>

Una vez completado y tengamos todas las imágenes necesarias cargadas, haremos click en "**Guardar**" para guardar los cambios en ese SKU.
