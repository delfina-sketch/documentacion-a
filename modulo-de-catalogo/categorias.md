...
metaLinks:
  alternates:
    - >-
      https://app.gitbook.com/s/72B6lE7Nn0jKtcyB10gI/modulo-de-catalogo/categorias
---
...
**Por ejemplo:** El departamento Baño tiene el ID 12. El nombre del Departamento es **"Baño"**. El número 12 es un indicador de VTEX, no forma parte del nombre de categoría.\
...
<figure><img src="../.gitbook/assets/40.gif" alt=""><figcaption></figcaption></figure>
